...
¡Ø If you first run the code, you need to download the data of gutenberg corpus
- uncomment the 51 line in the code

¡Ø When run the code, all results of probability distributions are saved in the result folder.
